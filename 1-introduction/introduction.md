...
> It's also possible to use models that accept other inputs as the
> Agent's core model. For example, a Vision Language Model (VLM), which
> is like an LLM but also understands images as input. 
...
![image](/1-introduction/img/image-generation-tool.jpg)
